...
{
    private static readonly Regex RomanNumeralRegex = new (@"\b(X|XX|XXX|XL|L|LX|LXX|LXXX|XC|C)?(I|II|III|IV|V|VI|VII|VIII|IX)?\b", RegexOptions.IgnoreCase | RegexOptions.Compiled);
